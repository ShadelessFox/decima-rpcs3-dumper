...
public final class RTTICompound extends RTTI {
    ...
    private final Slice<RTTIBase> bases;
    private final Slice<RTTIAttr> attrs;
    private final Slice<RTTIFunction> functions;
    private final Slice<RTTIMessageHandler> messageHandlers;
    ...
    public Slice<RTTIBase> getBases() {
        return bases;
    }

    public Slice<RTTIAttr> getAttrs() {
        return attrs;
    }

    public Slice<RTTIFunction> getFunctions() {
        return functions;
    }

    public Slice<RTTIMessageHandler> getMessageHandlers() {
